...
Sub Main(parms As Object)
	...
	Else If ( ( ( OccupancyMode = 100 OrElse OccupancyMode = 75 ) And parms = "" And CurrentHour >= 5 And CurrentHour < 9 ) OrElse parms = "Morning" ) Then
	...
	Else If ( ( ( OccupancyMode = 100 OrElse OccupancyMode = 75 ) And parms = "" And CurrentHour >= 19 And CurrentHour < 21 ) OrElse parms = "Evening" ) Then
	...
	Else If ( ( ( OccupancyMode = 100 OrElse OccupancyMode = 75 ) and parms = "" ) OrElse ( parms = "Day" ) ) Then
	...
	If ( OutsideTemperature > 100 ) Then
		SetCool = SetCool + 2
	Else If ( OutsideTemperature < 0 ) Then
		SetHeat = SetHeat - 2
	End If
